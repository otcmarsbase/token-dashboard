...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: 1GKZ90I6Fyh/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: zwmcUxC4SL1/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 1qknBLYfAX-/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__x0RXd)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__dlNJm)}
                role={"img"}
              />
            ),
